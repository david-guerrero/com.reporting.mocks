...
public class CalculationContextPubSubProducer {
    ...
    public CalculationContextPubSubProducer(ApplicationConfig appConfig) {
        producer = new PubSubProducer(appConfig.getCalculationContextTopic(), appConfig.getProjectId());
    }
