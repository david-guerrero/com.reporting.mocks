...
public class ResultPubSubPublisher implements IResultPublisher {
    ...
    public ResultPubSubPublisher(ApplicationConfig appConfig) {
        this.riskResultSetProducer = new RiskResultSetPubSubProducer(appConfig);
        this.riskResultProducer = new RiskResultPubSubProducer(appConfig);
        this.calculationContextProducer = new CalculationContextPubSubProducer(appConfig);
        this.tradePubSubPublisher = new TradePubSubPublisher(appConfig);
        this.marketEnvPubSubPublisher = new MarketEnvPubSubPublisher(appConfig);
    }
